...
function getCallLogReport_(params) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (!perAgent[agentPlain]) perAgent[agentPlain] = { calls: 0, talkSeconds: 0, outboundAnsweredCount: 0, outboundUnansweredCount: 0, outboundTalkSeconds: 0 };
    ...
    if (direction === "Outbound") {
      ...
      if (outboundResult === "Answered") {
        ...
        perAgent[agentPlain].outboundTalkSeconds += (Number(row[7]) || 0);
      } else {
